...
function addProduct() {
  ...
  if (input == ''){
    alert("What, you think you can just submit a text box that's empty? Are you insane?");
  }
  else{
    console.log(input);  //log for reference
  ...
  for(let i = 0; i < productArray.length; i++){
    console.log(Object.keys(productArray[i]));
    addedDiv.append(productArray[i].input);
    document.querySelector(".container2").appendChild(addedDiv);
  }
